...
with open('Attack_Dataset_Driving_All_multiclass.csv', 'w', newline='') as output_file:
    writer = csv.writer(output_file)
    with open('0_Training/Pre_train_D_1.csv', 'r') as input_file:
    ...
    with open('0_Training/Pre_train_D_2.csv', 'r') as input_file:
        reader = csv.reader(input_file)
        next(reader)
        for row in reader:
            if row[5] != "Replay" and row[5] != "Flooding":
...
input_file = "Attack_Dataset_Driving_All_multiclass.csv"
output_file = "Attack_Dataset_Driving_All_multiclass_data_split.csv"
...
input_file_path = "Attack_Dataset_Driving_All_multiclass_data_split.csv"
output_file_path = "Attack_Dataset_Driving_All_multiclass_new.csv"
...
with open("Attack_Dataset_Driving_All_multiclass_data_combined.csv", 'w', newline='') as output_file:
    writer = csv.writer(output_file)
    with open("Attack_Dataset_Driving_All_multiclass_new.csv", 'r') as input_file:
        reader = csv.reader(input_file)
        for row in reader:
...
input_file = "Attack_Dataset_Driving_All_multiclass_data_combined.csv"
output_file = "Attack_Dataset_Driving_no_duplicates.csv"
with open(input_file, 'r') as infile, open(output_file, 'w', newline='') as outfile:
